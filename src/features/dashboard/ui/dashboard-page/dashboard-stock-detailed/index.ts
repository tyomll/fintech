export { default as DashboardStockDetailedPage } from "./dashboard-stock-detailed-page";
export { default as DashboardStockDetailedHeader } from "./dashboard-stock-detailed-header";
