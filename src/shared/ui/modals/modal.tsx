...
const Modal = ({ open, onOpenChange, title, trigger, children }: Props) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="max-md:max-h-screen overflow-y-auto bg-slate-900/95 backdrop-blur-xl border border-slate-800/50 text-white max-w-2xl max-h-[80vh] overflow-hidden">
        <DialogHeader>
